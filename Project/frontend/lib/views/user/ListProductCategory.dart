...
class ListProductCategory extends StatefulWidget {
  String? category;
  String? name;
  ListProductCategory({super.key,required this.category, required this.name});

  @override
  State<ListProductCategory> createState() => ListProductCategoryViewState();
}

class ListProductCategoryViewState extends State<ListProductCategory> {
  ...
  Future<void> fetchProducts(String category) async {
    ...
    try{
      final res = await http.get(Uri.parse('$apiUrl/$category'));
      if(res.statusCode == 200) {
        final List<dynamic> data = jsonDecode(res.body);
        setState(() {
